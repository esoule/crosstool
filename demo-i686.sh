...
#eval `cat i686.dat gcc-3.3.4-glibc-2.1.3.dat`  sh all.sh --notest --buildrpm
...
#eval `cat i686.dat gcc-4.0-20050305-glibc-2.2.5.dat` sh all.sh --notest
#eval `cat i686.dat gcc-4.0-20050305-glibc-2.3.3.dat` sh all.sh --notest
#eval `cat i686.dat gcc-4.0-20050305-glibc-2.3.4.dat` sh all.sh --notest
#eval `cat i686.dat gcc-4.0-20050305-glibc-2.3-20050307.dat` sh all.sh --notest
